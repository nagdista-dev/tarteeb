const en = {
  ...
  'modal.detailsPlaceholder': 'Add journal, location, link…',
  ...
  'journal.studyNotes': 'Journal',
  'journal.newNote': 'New Entry',
  'journal.addNote': 'Add Entry',
  'journal.studyPlaceholder': 'Write your entry...',
  'journal.period': 'Period',
  'journal.allNotes': 'All Entries',
  'journal.noNotes': 'No entries yet. Write your first entry above.',
  'journal.edit': 'Edit',
  'journal.save': 'Save',
  'journal.cancel': 'Cancel',
  'journal.edited': 'edited',
  'journal.deleteConfirm': 'Delete this entry? This action cannot be undone.',
  ...
  'settings.notifSoundDesc': 'Play a custom sound instead of system default',
  'settings.notifVibrate': 'Vibration',
  'settings.notifVibrateDesc': 'Vibrate on notifications',
  ...
  'settings.pushNotif': 'Background Notifications',
  'settings.pushNotifDesc': 'Receive notifications even when the app is closed',
  'settings.pushActive': 'Background notifications: Active',
  'settings.pushInactive': 'Background notifications: Inactive',
  ...
  'alert.invalidTimeFormat': 'Invalid time format. Use HH:MM (e.g. 05:30).',
  ...
  'export.tasks': 'Tasks',
  'export.sleepSessions': 'Sleep Sessions',
  'export.session': 'Session',
  'export.start': 'Start',
  'export.end': 'End',
  'export.total': 'Total',
  'export.noSessions': 'No Sessions',
  'export.drinks': 'Drinks',
  'export.drink': 'Drink',
  'export.amount': 'Amount',
  'export.noDrinks': 'No Drinks',
  'export.task': 'Task',
  'export.noTasks': 'No Tasks',
  'export.generatedBy': 'Generated by Tarteeb',
  'export.daySystem': 'Day System: Starts at',
  'export.mainSleep': 'Main Sleep',
  ...
  'guide.journal': 'Journal — Daily Entries',
  ...
  'pulse.noNotes': 'No entries today.',
  'pulse.studyNotes': 'Journal',
  ...
  'habits.today': 'Today',
  'habits.notes': 'Journal',
  'habits.notesPlaceholder': 'Add entry...',
...
const ar = {
  ...
  'modal.detailsPlaceholder': 'أضف يوميات، موقع، رابط…',
  ...
  /* Journal page */
  'journal.title': 'يوميات',
  'journal.studyNotes': 'يوميات',
  'journal.newNote': 'إدخال جديد',
  'journal.addNote': 'إضافة إدخال',
  'journal.studyPlaceholder': 'اكتب إدخالك...',
  'journal.period': 'الوقت',
  'journal.allNotes': 'جميع الإدخالات',
  'journal.noNotes': 'لا توجد إدخالات بعد. اكتب إدخالك الأول أعلاه.',
  'journal.edit': 'تعديل',
  'journal.save': 'حفظ',
  'journal.cancel': 'إلغاء',
  'journal.edited': 'تم التعديل',
  'journal.deleteConfirm': 'حذف هذا الإدخال؟ لا يمكن التراجع عن هذا الإجراء.',
  ...
  'settings.notifSoundDesc': 'تشغيل صوت مخصص بدلاً من صوت النظام الافتراضي',
  'settings.notifVibrate': 'الاهتزاز',
  'settings.notifVibrateDesc': 'الاهتزاز عند وصول الإشعارات',
  ...
  'settings.pushNotif': 'إشعارات الخلفية',
  'settings.pushNotifDesc': 'استقبل الإشعارات حتى عندما يكون التطبيق مغلقاً',
  'settings.pushActive': 'إشعارات الخلفية: نشطة',
  'settings.pushInactive': 'إشعارات الخلفية: غير نشطة',
  ...
  'alert.invalidTimeFormat': 'صيغة الوقت غير صالحة. استخدم HH:MM (مثال: 05:30).',
  ...
  'export.notes': 'يوميات',
  'export.tasks': 'المهام',
  'export.sleepSessions': 'جلسات النوم',
  'export.session': 'الجلسة',
  'export.start': 'البداية',
  'export.end': 'النهاية',
  'export.total': 'الإجمالي',
  'export.noSessions': 'لا توجد جلسات',
  'export.drinks': 'المشروبات',
  'export.drink': 'المشروب',
  'export.amount': 'الكمية',
  'export.noDrinks': 'لا توجد مشروبات',
  'export.task': 'المهمة',
  'export.noTasks': 'لا توجد مهام',
  'export.generatedBy': 'تم التوليد بواسطة ترتيب',
  'export.daySystem': 'نظام اليوم: يبدأ عند',
  'export.mainSleep': 'النوم الرئيسي',
  ...
  'pulse.noNotes': 'لا توجد إدخالات اليوم.',
  'pulse.studyNotes': 'يوميات',
  ...
  'habits.today': 'اليوم',
  'habits.notes': 'يوميات',
  'habits.notesPlaceholder': 'أضف إدخال...',
