const en = {
  ...
  'guide.whatIsDesc': 'Tarteeb is a daily planner organised around the five Islamic prayer times. Each day starts at Maghrib and runs through to the next Asr. The sidebar gives you quick access to all pages, your daily info, and export options. The Pulse dashboard shows your daily progress at a glance — tasks, prayers, habits, and notes.',
  'guide.timeline': 'The Timeline',
  'guide.timelineDesc': 'The home page shows a vertical timeline of your entire day. The red line marks the current time. Each task appears as a card inside its prayer block. You can mark tasks complete, edit them, or delete them directly from the timeline.',
  'guide.addTask': 'Adding & Editing Tasks',
  'guide.addTaskDesc': 'Tap the green + button at the bottom-right of the screen. Choose a name, set the time block (e.g. Morning, Afternoon), pick a start and end time, and optionally mark it as recurring. Fixed prayer tasks (Fajr, Dhuhr, etc.) are added automatically and cannot be edited or deleted.',
  'guide.journal': 'Daily Notes',
  'guide.journalDesc': 'The Notes page lets you write quick notes or reflections for the day, grouped by prayer period. Your entries are saved locally and appear in the Pulse dashboard.',
  'guide.history': 'Pulse Dashboard',
  'guide.historyDesc': 'The Pulse (Nabd Al-Muslim) page gives you a complete overview of your day — prayer tracking, task completion by period, today\'s habits, and a summary of your notes — all in one place with Obsidian-style cards.',
  ...
  'guide.export': 'Export',
  'guide.exportDesc': 'Open the sidebar and use the Export buttons at the bottom. "Export Day" downloads a Markdown (.md) file with prayer times, tasks, habits, notes, and your journal. "Prev Day" exports yesterday\'s data. The file uses your selected language.',
  'guide.theme': 'Theme & Language',
  'guide.themeDesc': 'Use the quick action buttons in the sidebar to toggle between light and dark mode or switch between English and Arabic. You can also change the font size. Your preferences are remembered for next time.',
  ...
  /* Pulse page */
  'nav.pulse': 'Pulse',
  'pulse.title': 'Muslim Pulse',
  'pulse.subtitle': 'Your daily spiritual and productivity dashboard',
  'pulse.noData': 'Plan today to see your pulse!',
...
const ar = {
  ...
  'guide.whatIsDesc': 'ترتيب هو مخطط يومي منظم حول أوقات الصلاة الإسلامية الخمس. يبدأ كل يوم عند المغرب ويمتد حتى العصر من اليوم التالي. يمنحك الشريط الجانبي وصولاً سريعاً لجميع الصفحات ومعلومات يومك وخيارات التصدير. لوحة نبض المسلم تظهر لك ملخص يومك في لمحة — المهام والصلوات والعادات والملاحظات.',
  'guide.timeline': 'الخط الزمني',
  'guide.timelineDesc': 'تعرض الصفحة الرئيسية خطاً زمنياً عمودياً ليومك بالكامل. الخط الأحمر يحدد الوقت الحالي. كل مهمة تظهر كبطاقة داخل حزمتها الزمنية. يمكنك تحديد المهام كمكتملة أو تعديلها أو حذفها مباشرة من الخط الزمني.',
  'guide.addTask': 'إضافة وتعديل المهام',
  'guide.addTaskDesc': 'اضغط على زر + الأخضر في أسفل يمين الشاشة. اختر اسماً، وحدد الحزمة الزمنية (مثلاً الصباح، الظهر)، واختر وقت البداية والنهاية، ويمكنك جعلها متكررة. المهام الثابتة (الفجر، الظهر، إلخ) تضاف تلقائياً ولا يمكن تعديلها أو حذفها.',
  'guide.journal': 'الملاحظات اليومية',
  'guide.journalDesc': 'تتيح لك صفحة الملاحظات كتابة ملاحظات سريعة أو تأملات لليوم، مجمعة حسب الفترة الزمنية. يتم حفظ إدخالاتك محلياً وتظهر في لوحة نبض المسلم.',
  'guide.history': 'لوحة نبض المسلم',
  'guide.historyDesc': 'صفحة نبض المسلم تعطيك نظرة شاملة ليومك — تتبع الصلوات، المهام حسب الفترة، عادات اليوم، وملخص الملاحظات — كلها في مكان واحد ببطاقات على نمط Obsidian.',
  ...
  'guide.exportDesc': 'افتح الشريط الجانبي واستخدم أزرار التصدير في الأسفل. "تصدير اليوم" ينزّل ملف ماركداون (.md) يحتوي على أوقات الصلاة والمهام والعادات والملاحظات والمذكرات. "اليوم السابق" يصدّر بيانات الأمس. الملف يستخدم لغتك المختارة.',
  'guide.theme': 'السمة واللغة',
  'guide.themeDesc': 'استخدم أزرار الإجراءات السريعة في الشريط الجانبي للتبديل بين الوضع الفاتح والداكن أو التبديل بين الإنجليزية والعربية. يمكنك أيضاً تغيير حجم الخط. يتم تذكر تفضيلاتك للمرة القادمة.',
  ...
  /* Pulse page */
  'nav.pulse': 'النبض',
  'pulse.title': 'نبض المسلم',
  'pulse.subtitle': 'لوحة تحكم يومية للروحانية والإنتاجية',
  'pulse.noData': 'خطط ليومك لترى نبضك!',
