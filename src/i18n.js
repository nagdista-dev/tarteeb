const en = {
  ...
  'pulse.subtitle': 'Your productivity overview for the past 7 days',
  'pulse.noData': 'Not enough data yet. Keep planning your days!',
  'pulse.completionRate': 'Completion Rate',
  'pulse.tasksDone': 'Tasks Done',
  'pulse.bestDay': 'Best Day',
  'pulse.prayerAccuracy': 'Prayer Tracking',
  ...
  'timer.cycle': 'Cycle',
  'timer.dhikrTitle': 'Dhikr Reminder',
  'timer.dhikrBody': 'Take a moment to remember Allah during your break.',
  'timer.completeTitle': 'Session Complete!',
  'timer.completeBody': 'Great focus! Take a well-deserved break.',
  'timer.adhkar1': 'SubhanAllah ×33',
  'timer.adhkar2': 'Alhamdulillah ×33',
  'timer.adhkar3': 'Allahu Akbar ×34',
...
const ar = {
  ...
  /* Pulse page */
  'nav.pulse': 'النبض',
  'pulse.title': 'نبض الأسبوع',
  'pulse.subtitle': 'نظرة عامة على إنتاجيتك خلال الأيام السبعة الماضية',
  'pulse.noData': 'لا توجد بيانات كافية بعد. استمر في تخطيط أيامك!',
  'pulse.completionRate': 'معدل الإنجاز',
  'pulse.tasksDone': 'المهام المنجزة',
  'pulse.bestDay': 'أفضل يوم',
  'pulse.prayerAccuracy': 'تتبع الصلاة',
  ...
  'timer.cycle': 'دورة',
  'timer.dhikrTitle': 'تذكير بالذكر',
  'timer.dhikrBody': 'اغتنم فرصة الاستراحة لذكر الله.',
  'timer.completeTitle': 'اكتملت الجلسة!',
  'timer.completeBody': 'تركيز رائع! خذ استراحة مستحقة.',
  'timer.adhkar1': 'سبحان الله ×٣٣',
  'timer.adhkar2': 'الحمد لله ×٣٣',
  'timer.adhkar3': 'الله أكبر ×٣٤',
